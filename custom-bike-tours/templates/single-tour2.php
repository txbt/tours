...
//var_dump($tid);
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-md-6">
                    <div  class="clear">
                      ...
                      <a style="padding:3%; font-size:1.1em;" class="btn btn-primary btn-lg" id="rent" href="http://www.texasbiketours.com/book-tour?tourID=<?php echo $post->ID; ?>&tourName=<?php echo urlencode(get_the_title($tourID)); ?>">RESERVE THIS TOUR
                      </a>
                    </div>
                  </div>
                </div>
      ...
      //   echo '<hr />';
       ...
       //     echo "FOUND";
        ...
        <div id="allreviews" style="clear:both;text-align:center; width:100%;">
          <a id="allreviews_btn" class="btn btn-default btn-lg" href="<?php echo get_site_url(); ?>/tour_review/" >Read All Reviews</a>
    ...
    <div  class="clear" style="text-align:center; width:100%;">
                      <!-- <a class="btn" id="custom">CUSTOMIZE THIS TOUR</a> -->
                      <a style="padding:2%; font-size:1.1em;" class="btn btn-primary btn-lg" id="rent" href="http://www.texasbiketours.com/book-tour?tourID=<?php echo $post->ID; ?>&tourName=<?php echo urlencode(get_the_title($tourID)); ?>">RESERVE THIS TOUR
                      </a>
                    </div>
